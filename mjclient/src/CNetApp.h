...
const int ONTIMER_READY_TIME = 3000;

const int ON_ZHUOZHUANG_TIME = 3000;

const int ON_LAZHUANG_TIME = 3000;

const int ON_DASAIZI_TIME = 3000;

const int ON_DASAIZI_AG_TIME = 3000;

const int ON_DAPAI_TIME = 2000;

const int ON_PENG_TIME = 3000;

const int ON_GANG_TIME = 3000;

const int ON_MOPAI_TIME = 2000;
