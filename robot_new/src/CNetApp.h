...
const int ONTIMER_READY_TIME = 300;

const int ON_ZHUOZHUANG_TIME = 300;

const int ON_LAZHUANG_TIME = 300;

const int ON_DASAIZI_TIME = 300;

const int ON_DASAIZI_AG_TIME = 300;

const int ON_DAPAI_TIME = 200;

const int ON_PENG_TIME = 300;

const int ON_GANG_TIME = 300;

const int ON_MOPAI_TIME = 200;
